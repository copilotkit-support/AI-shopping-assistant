  ...
  return (
    <div className="border border-gray-300 rounded-lg shadow-lg w-54 max-h-96 overflow-hidden flex flex-col">
      ...
      <div className="flex justify-between p-4 border-t border-gray-200">
        ...
        <button disabled={isDisabled} onClick={onNeedInfo} className="bg-yellow-500 text-white py-1 px-3 rounded-full shadow-md hover:shadow-lg transition-shadow duration-200 text-sm bg-opacity-80 backdrop-filter backdrop-blur-lg">Need Info</button>
      </div>
    </div>
  );
};
